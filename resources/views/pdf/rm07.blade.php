...
<body ng-controller="cetakAsesmenAwalKeperawatanIGD">
    <section>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="1">
            ...
            <tr height="18px">
                ...
                <td colspan="2">: @{{ item.obj[420638] ? item.obj[420638] : '' }} x/m</td>
                <td></td>
                ...
                <td colspan="2">@{{ item.obj[420640] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak, </td>
                <td colspan="3">Jelaskan: @{{ item.obj[420641] ? item.obj[420641] : '' }}</td>
            </tr>
            <tr height="18px">
                <td colspan="2" class="border-left">Circulation</td>
                <td colspan="2">TD</td>
                <td colspan="2">: @{{ item.obj[420642] ? item.obj[420642] : '' }} mmHg</td>
                <td></td>
                <td colspan="">Nadi</td>
                <td colspan="3"> @{{ item.obj[420643] ? item.obj[420643] : '' }} x/m</td>
            ...
            <tr height="18px">
                ...
                <td colspan="4">: @{{ item.obj[420646] ? item.obj[420646] : '' }} °C</td>
                <td></td>
                <td colspan="">Akral</td>
            ...
            <tr height="18px">
                ...
                <td colspan="5">@{{ item.obj[420652] ? item.obj[420652] : '___' }} Detik</td>
                <td colspan="5"></td>
                <td colspan="5">SPO2, Jelaskan : @{{ item.obj[420653] ? item.obj[420653] : '___' }}
                    %</td>
                <td></td>
            </tr>
            ...
            <tr height="18px">
                <td colspan="6" class="border-left">Kesadaran : @{{ item.obj[420654] ?
                    item.obj[420654] : '' }}</td>
                <td colspan="6" class="border-left"></td>
                <td colspan="6" class="border-left"></td>
            </tr>
            <tr height="18px">
                <td colspan="6" class="border-left">GCS : E : @{{ item.obj[420655] ?
            ...
            <tr height="18px">
                <td colspan="3" class="border-left">@{{ item.obj[420658] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Mandiri</td>
                <td colspan="3">@{{ item.obj[420659] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Dibantu</td>
                <td colspan="3" class="border-left">@{{ item.obj[420669] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Jelas</td>
                <td colspan="3">@{{ item.obj[420670] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Pendarahan</td>
                <td colspan="6" class="border-left">@{{ item.obj[420676] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Denyut Nadi (-)</td>
            </tr>
            <tr height="18px">
                <td colspan="3" class="border-left">@{{ item.obj[420660] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Alert</td>
                <td colspan="3">@{{ item.obj[420661] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Pain</td>
                <td colspan="3" class="border-left">@{{ item.obj[420671] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Fraktur</td>
                <td colspan="3">@{{ item.obj[420672] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Normal</td>
                <td colspan="6" class="border-left">@{{ item.obj[420677] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Reflek Cahaya (-)</td>
            </tr>
            <tr height="18px">
                <td colspan="3" class="border-left">@{{ item.obj[420662] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Verbal</td>
                <td colspan="3">@{{ item.obj[420663] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Non Verbal</td>
                <td colspan="3" class="border-left">@{{ item.obj[420673] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Hematom</td>
                <td colspan="3">@{{ item.obj[420674] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Deformitas</td>
                <td colspan="6" class="border-left">@{{ item.obj[420678] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} EKG
                    Asystole</td>
            </tr>
            ...
            <tr height="18px">
                ...
                <td colspan="6" class="border-left">@{{ item.obj[420675] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Luka</td>
                <td colspan="6" class="border-left">Penentuan Kematian Pukul: @{{item.obj[420679] | toDate |
                    date:'HH:mm'}} WITA</td>
            </tr>

            <tr height="18px">
                <td colspan="2" class="border-left">@{{ item.obj[420664] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Isokor</td>
                <td colspan="2">@{{ item.obj[420665] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Anisokor</td>
                <td colspan="2">@{{ item.obj[420666] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Midriasis</td>
                <td colspan="6" class="border-left"></td>
                <td colspan="6" class="border-left"></td>
            </tr>
            <tr>
                <td colspan="6" class="border-left">Refleks: @{{ item.obj[420667] ?
        ...
        <table width="100%" class="table-border" style="margin-top:-5px">
            ...
            <tr>
                ...
                <td colspan="2" class="border-left border-bottom">@{{ item.obj[420741] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak Ada</td>
                <td colspan="16" class="border-bottom">@{{ item.obj[420742] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Ada
    ...
    2. Menopang saat akan duduk : Tampak memegang pinggiran kursi atau meja/ 
       benda lain sebagai penopang saat akan duduk.
            ...
            <tr>
                <td colspan="2" class="border-left border-bottom">@{{ item.obj[420755] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
            ...
            <tr class="bordered">
                ...
                <td colspan="8" class="border-left">Lingkar Kepala : @{{ item.obj[420768] ? item.obj[420768] : '' }}
                </td>
            ...
            <tr class="bordered">
                ...
                <td colspan="2" class="border-left">@{{ item.obj[420770] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
                <td colspan="2" class="border-left">@{{ item.obj[420771] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
            </tr>
            <tr class="bordered">
                <td style="text-align:center">2</td>
                <td colspan="13" class="border-left">Berat badan berkurang dalam 3 bulan</td>
                <td colspan="2" class="border-left">@{{ item.obj[420773] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
                <td colspan="2" class="border-left">@{{ item.obj[420774] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
            </tr>
            <tr class="bordered">
                <td style="text-align:center">3</td>
                <td colspan="13" class="border-left">Asupan makan menurun dalam 1 minggu terakhir</td>
                <td colspan="2" class="border-left">@{{ item.obj[420776] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
                <td colspan="2" class="border-left">@{{ item.obj[420777] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
            </tr>
            <tr class="bordered">
                ...
                <td colspan="13" class="border-left">Menderita sakit berat, misalnya: kesadaran menurun dan terapi
                    intensif</td>
                <td colspan="2" class="border-left">@{{ item.obj[420779] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
                <td colspan="2" class="border-left">@{{ item.obj[420780] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
            </tr>
            <tr class="bordered">
                ...
                <td colspan="2" class="border-left">@{{ item.obj[420782] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya
                </td>
                <td colspan="2" class="border-left">@{{ item.obj[420783] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
            </tr>
            <tr class="bordered">
            ...
            <tr>
                <td colspan="5" class=" border-left">@{{ item.obj[420785] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Pasien</td>
                <td colspan="13">@{{ item.obj[420786] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Keluarga</td>
            </tr>
            <tr>
                <td colspan="18" class="border-bottom border-left">@{{ item.obj[420787] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }}
            ...
            <tr>
                ...
                <td colspan="9" class="border-bottom ">@{{ item.obj[420792] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Poli
            ...
            <tr>
                ...
                <td colspan="9" class="border-bottom">@{{ item.obj[420796] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    RS
                </td>
            </tr>
            <tr>
                <td colspan="18" class="border-bottom border-left">Rawat inap, Bagian / Ruang : @{{ item.obj[420799] ?
                    item.obj[420799] : '' }}</td>
            ...
            <tr style="text-align:center;">
                <td colspan="3" class="bordered">@{{ item.obj[420801] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Menurun
                </td>
                <td colspan="4" class="bordered">@{{ item.obj[420802] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Menurun</td>
                <td colspan="3" class="bordered">@{{ item.obj[420803] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Sedang
                </td>
                <td colspan="4" class="bordered">@{{ item.obj[420804] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Meningkat</td>
                <td colspan="4" class="bordered">@{{ item.obj[420805] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Meningkat</td>
            </tr>
            <tr style="text-align:center;">
                <td colspan="3" class="bordered">@{{ item.obj[420806] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Meningkat</td>
                <td colspan="4" class="bordered">@{{ item.obj[420807] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Meningkat</td>
                <td colspan="3" class="bordered">@{{ item.obj[420808] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Sedang
                </td>
                <td colspan="4" class="bordered">@{{ item.obj[420809] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Menurun</td>
                <td colspan="4" class="bordered">@{{ item.obj[420810] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Menurun
                </td>
            </tr>
            <tr style="text-align:center;">
                <td colspan="3" class="bordered">@{{ item.obj[420811] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Memburuk</td>
                <td colspan="4" class="bordered">@{{ item.obj[420812] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Memburuk</td>
                <td colspan="3" class="bordered">@{{ item.obj[420813] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Sedang
                </td>
                <td colspan="4" class="bordered">@{{ item.obj[420814] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cukup
                    Membaik</td>
                <td colspan="4" class="bordered">@{{ item.obj[420815] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Membaik
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420816] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420817] ? item.obj[420817] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420818] ? item.obj[420818] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420819] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420820] ? item.obj[420820] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420821] ? item.obj[420821] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420822] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420823] ? item.obj[420823] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420824] ? item.obj[420824] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420825] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420826] ? item.obj[420826] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420827] ? item.obj[420827] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420828] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420829] ? item.obj[420829] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420830] ? item.obj[420830] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420831] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420832] ? item.obj[420832] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420833] ? item.obj[420833] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420834] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420835] ? item.obj[420835] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420836] ? item.obj[420836] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420837] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420838] ? item.obj[420838] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420839] ? item.obj[420839] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420840] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420841] ? item.obj[420841] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420842] ? item.obj[420842] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420843] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420844] ? item.obj[420844] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420845] ? item.obj[420845] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420846] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420847] ? item.obj[420847] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420848] ? item.obj[420848] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420849] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420850] ? item.obj[420850] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420851] ? item.obj[420851] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420852] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420853] ? item.obj[420853] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420854] ? item.obj[420854] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420855] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420856] ? item.obj[420856] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420857] ? item.obj[420857] : '' }}</td>
            </tr>
            <tr>
                <td colspan="2" class="bordered">@{{item.obj[420858] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
                <td colspan="11" class="bordered">@{{ item.obj[420859] ? item.obj[420859] : '' }}</td>
                <td colspan="5" class="bordered">@{{ item.obj[420860] ? item.obj[420860] : '' }}</td>
            </tr>
            <tr>
                <td colspan="11">Bulukumba: @{{item.obj[420861] | toDate
