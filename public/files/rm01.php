    ...
    -->
        ...
        <!--table width="100%" style="table-layout:fixed;">
            ...
            <tr style="height:21px">
                ...
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420303] ? item.obj[420303] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000">{!!
                    $res['d'][0]->jeniskelamin == 'PEREMPUAN' ? 'P' : 'L' !!}</td>
                <td colspan="15">No. RM : @{{ item.obj[420304] ? item.obj[420304] : '' }}</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Tgl Lahir</td>
                <td colspan="4" style="border:none;">: @{{ item.obj[420307] ? item.obj[420307] :
                    '_________________________________________________' }}</td>
            ...
            <tr style="height:21px">
                ...
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420308] ? item.obj[420308] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="15" style="border:none;">@{{ item.obj[420312] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Kawin</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Kebangsaan</td>
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420309] ? item.obj[420309] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="15" style="border:none;">@{{ item.obj[420313] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Belum Kawin</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Alamat</td>
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420310] ? item.obj[420310] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="15" style="border:none;">@{{ item.obj[420314] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Janda / Duda</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Nomor Tlpn/HP</td>
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420311] ? item.obj[420311] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
            ...
            <!--tr style="height:21px">
                ...
                <td colspan="4" style="text-align:left;border:none;border-top:1px solid #000;">: @{{ item.obj[420315] ?
                    item.obj[420315] : '_________________________________________________' }}</td>
                <td
                    style="text-align:center;width:25px;border:none;border-right:1px solid #000;border-top:1px solid #000;">
                </td>
            ...
            <tr style="height:21px">
                ...
                <td colspan="4" style="border:none;">: @{{ item.obj[420316] ? item.obj[420316] :
                    '_______________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
            ...
            <tr style="height:21px">
                ...
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420317] ? item.obj[420317] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="14" style="border:none;">Dr. Poliklinik : @{{ item.obj[420322] ? item.obj[420322] :
                    '_______________________' }}</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Alamat</td>
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420318] ? item.obj[420318] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="15" style="border:none;">Dr. Jaga : @{{ item.obj[420325] ? item.obj[420323] :
                    '_______________________' }}</td>
            </tr>
            <tr style="height:21px">
                <td colspan="2" style="border:none;">Nomor Tlpn/HP</td>
                <td colspan="4" style="text-align:left;border:none;">: @{{ item.obj[420319] ? item.obj[420319] :
                    '_________________________________________________' }}</td>
                <td style="text-align:center;width:25px;border:none;border-right:1px solid #000"></td>
                <td colspan="15" style="border:none;">Rujukan dari : @{{ item.obj[420324] ? item.obj[420324] :
                    '_______________________' }}</td>
            </tr>

            <!-- part 3 --
            <tr style="height:20px;vertical-align: top;border-top:1px solid #000;text-align: center;">
                <td colspan="2" style="border:none;">Sebab Dirawat : @{{ item.obj[420325] ? item.obj[420325] : '' }}
                </td>
                <td colspan="4" style="border:none;">Masuk Tanggal : @{{item.obj[420327] | toDate | date:'dd MMMM
                    yyyy'}}</td>
            ...
            <tr style="height:20px;vertical-align: top;text-align: center;">
                <td colspan="2" style="border:none; width:100px">Dirawat di ruang : @{{ item.obj[420326] ?
                    item.obj[420326] : '' }}</td>
            ...
            <tr style="border-top:1px solid #000">
                ...
                <td style="border:none;border-bottom:none" colspan="2">@{{ item.obj[420330] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Ya</td>
                <td style="border:none;" colspan="">Prosedur Masuk RS Melalui : </td>
                <td style="border:none;" colspan="3">@{{ item.obj[420332] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} IRD
                </td>
                <td style="border:none;" colspan="2">Peserta BPJS : </td>
                <td style="border:none;" colspan="8">@{{ item.obj[420334] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} PBI
                </td>
                <td style="border:none;" colspan="">@{{ item.obj[420336] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Umum
                </td>
            </tr>
            <tr style="border:none;">
                <td style="border:none;" colspan="3">@{{ item.obj[420331] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Tidak</td>
                <td style="border:none;" colspan="5">@{{ item.obj[420333] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Poliklinik</td>
                <td style="border:none;" colspan="8">@{{ item.obj[420335] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Non
                    PBI</td>
                <td style="border:none;">@{{ item.obj[420337] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Gratis</td>
            </tr>
            <tr>
                <td colspan="19" style="border:none;padding-left:455px;">No. BPJS: @{{ item.obj[420338] ?
                    item.obj[420338] : '_______________________' }}</td>
            </tr>
            <tr style="border:none">
                <td colspan="19" style="border:none;padding-left:455px;">Kelas Perawatan / Jaminan: @{{ item.obj[420339]
                    ? item.obj[420339] : '_______________________' }}</td>
            </tr>
            <tr style="border:1px solid #000; text-align:center;height:25px;border-bottom:none">
                <td colspan="6" style="border:none">Dipindahkan ke ruang : @{{ item.obj[420340] ? item.obj[420340] : ''
                    }}</td>
                <td colspan="14" style="border:none">Pindahan dari ruang : @{{ item.obj[420343] ? item.obj[420343] : ''
                    }}</td>
            </tr>
            <tr style="border:1px solid #000;border-top:none; text-align:center;height:25px">
                <td style="border:none" colspan="6">Kelas: @{{ item.obj[420341] ? item.obj[420341] : '______________'
                    }}, Tgl: @{{item.obj[420342] | toDate | date:'dd MMMM yyyy'}}, Jam: @{{item.obj[420342] | toDate |
                    date:'HH:mm'}}</td>
                <td style="border:none" colspan="14">Kelas: @{{ item.obj[420344] ? item.obj[420344] : '______________'
                    }}, Tgl: @{{item.obj[420345] | toDate | date:'dd MMMM yyyy'}}, Jam: @{{item.obj[420345] | toDate |
                    date:'HH:mm'}}</td>
            </tr>
            <tr>
                <td colspan="5" height="25px" valign="top">Meninggal Tgl : @{{item.obj[420346] | toDate | date:'dd MMMM
                    yyyy HH:mm'}}</td>
                <td colspan="15" height="25px" valign="top">Sebab Kematian : @{{ item.obj[420347] ? item.obj[420347] :
                    '' }}</td>
            </tr>
            <tr>
                <td colspan="5" height="25px" valign="top">Alergi Terhadap : @{{ item.obj[420348] ? item.obj[420348] :
                    '' }}</td>
                <td colspan="15" height="25px" valign="top">Cacat Bawaan : @{{ item.obj[420349] ? item.obj[420349] : ''
                    }}</td>
            </tr>
            <tr>
                <td colspan="5" height="25px" valign="top">Diagnosa Awal : @{{ item.obj[420351] ? item.obj[420351] : ''
                    }} @{{ item.obj[420352] ? item.obj[420352] : '' }}</td>
                <td colspan="15" height="25px" valign="top">Diagnosa Akhir : @{{ item.obj[420354] ? item.obj[420354] :
                    '' }} @{{ item.obj[420355] ? item.obj[420355] : '' }}</td>
            </tr>
            <tr>
                <td colspan="20" height="25px" valign="top">Diagnosa sekunder (termasuk komplikasi/ manifestasi) : @{{
                    item.obj[420357] ? item.obj[420357] : '' }} @{{ item.obj[420358] ? item.obj[420358] : '' }}</td>
            </tr>
            <tr>
                <td colspan="20" height="25px" valign="top">Diagnosa sekunder (termasuk komplikasi/ manifestasi) : @{{
            ...
            <tr>
                <td colspan="20" height="25px" valign="top">Tindakan Operasi yang dilakukan (bila ada, sebutkan) : @{{
                    item.obj[420359] ? item.obj[420359] : '' }}</td>
            </tr>
            <tr>
                <td colspan="5" height="25px" valign="top">Infeksi Nosokomial : @{{ item.obj[420360] ? item.obj[420360]
                    : '' }}</td>
                <td colspan="15" height="25px" valign="top">Penyebab Infeksi : @{{ item.obj[420361] ? item.obj[420361] :
                    '' }}</td>
            </tr>
            ...
            <tr style="border:none;height:25px">
                <td colspan="2" style="border:none">@{{ item.obj[420362] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Sudah KB</td>
                <td colspan="2" style="border:none">@{{ item.obj[420363] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} MOV
                    / MOW</td>
                <td colspan="" style="border:none">@{{ item.obj[420364] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} IUD
                </td>
                <td colspan="5" style="border:none">@{{ item.obj[420365] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Suntikan</td>
                <td colspan="6" style="border:none">@{{ item.obj[420366] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Kondom</td>
                <td colspan="4" style="border:none; padding-left:90px">@{{ item.obj[420367] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Pil KB</td>
            </tr>
            <tr style="border:none;height:25px">
                <td colspan="2" style="border:none">@{{ item.obj[420368] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Belum KB</td>
            ...
            <tr style="border:1px solid #000;height:25px">
                ...
                <td style="border:none">@{{ item.obj[420371] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} BCG</td>
                <td style="border:none">@{{ item.obj[420372] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} DPT</td>
                <td style="border:none" colspan="3">@{{ item.obj[420373] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Polio</td>
                <td style="border:none" colspan="3">@{{ item.obj[420374] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} TFT
                </td>
                <td style="border:none" colspan="8">@{{ item.obj[420375] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Campak</td>
            </tr>
            <tr>
                <td colspan="20">Imunisasi yang diperoleh selama di rawat : @{{ item.obj[420376] ? item.obj[420376] : ''
                    }}</td>
            </tr>
            <tr>
                <td colspan="20">Pengobatan Radioterapi / Ked. Nuklir : @{{ item.obj[420377] ? item.obj[420377] : '' }}
                </td>
            </tr>
            <tr>
            ...
            <tr style="height:25px">
                <td style="border:none;" colspan="2">@{{ item.obj[420380] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Sembuh</td>
                <td style="border:none;" colspan="2">@{{ item.obj[420381] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Membaik</td>
                <td style="border:none;border-right:1px solid #000">@{{ item.obj[420382] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Belum Sembuh</td>
                <td style="border:none;" colspan="2">@{{ item.obj[420385] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Diijinkan Pulang</td>
                <td style="border:none;" colspan="4">@{{ item.obj[420386] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Pulang paksa</td>
                <td style="border:none;" colspan="9">@{{ item.obj[420387] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Lari</td>
            </tr>
            <tr style="height:25px">
                <td style="border:none" colspan="2">@{{ item.obj[420383] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Meninggal < 48 Jam</td>
                <td style="border:none;border-right:1px solid #000" colspan="3">@{{ item.obj[420384] ? '[&#10004;]' :
                    '[&nbsp;&nbsp;&nbsp;]' }} Meninggal > 48 Jam</td>
                <td style="border:none" colspan="2">@{{ item.obj[420388] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Pindah RS Lain</td>
                <td style="border:none" colspan="13">@{{ item.obj[420389] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}
                    Dirujuk Ke: @{{ item.obj[420390] ? item.obj[420390] : '__________' }}</td>
            </tr>
            <tr style="border:none;border-top:1px solid #000;height:25px">
                <td style="border:none;border-right:1px solid #000" colspan="5">Keluar Tanggal : @{{item.obj[420391] |
                    toDate | date:'dd MMMM yyyy'}}</td>
                <td style="border:none" colspan="15">Dokter Penanggung Jawab Pelayanan : @{{ item.obj[420393] ?
                    item.obj[420393] : '' }}</td>
            </tr>
            <tr style="border:none;height:25px">
                <td style="border:none;border-right:1px solid #000" colspan="5">Jam : @{{item.obj[420391] | toDate |
                    date:'HH:mm'}}</td>
                <td style="border:none" colspan="15" rowspan="2">
                    <div id="qrcodeDPJP" style="text-align: center"></div>
                </td>
            </tr>
            <tr style="border:none;height:25px">
                <td style="border:none;border-right:1px solid #000" colspan="5">Lama Dirawat : @{{ item.obj[420392] ?
                    item.obj[420392] : '' }}</td>
            </tr>
